...
/**
 * Creates an output target for binding Rindo components to be used in a React context
 * @param outputTarget the user-defined output target defined in a Rindo configuration file
 * @returns an output target that can be used by the Rindo compiler
 */
...
/**
 * Normalizes the structure of a provided output target and verifies a Rindo configuration
