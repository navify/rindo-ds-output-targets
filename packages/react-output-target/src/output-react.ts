...
import type { CompilerCtx, ComponentCompilerMeta, Config, CopyResults, OutputTargetDist } from '@rindo/core/internal';

/**
 * Generate and write the Rindo-React bindings to disc
 * @param config the Rindo configuration associated with the project
 * @param compilerCtx the compiler context of the current Rindo build
...
/**
 * Generate the code that will be responsible for creating the Rindo-React bindings
 * @param config the Rindo configuration associated with the project
 * @param components the Rindo components to generate wrappers for
 * @param pkgData `package.json` data for the Rindo project
 * @param outputTarget the output target configuration used to generate the Rindo-React bindings
 * @param rootDir the directory of the Rindo project
 * @returns the generated code to create the Rindo-React bindings
 */
...
/**
 * Copy resources used to generate the Rindo-React bindings. The resources copied here are not specific a project's
 * Rindo components, but rather the logic used to do the actual component generation.
 * @param config the Rindo configuration associated with the project
 * @param outputTarget the output target configuration for generating the Rindo-React bindings
 ...
 * @param config the Rindo configuration for the project
 * @param outputTarget the output target used for generating the Rindo-React bindings
